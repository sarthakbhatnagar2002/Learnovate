...
function ProfilePage() {
    ...
    const fetchUserProfile = async () => {
        try {
            ...
            if (response.ok) {
                ...
                // Profile doesn't exist yet, keep empty state
    ...
    const handleSave = async () => {
        try {
            ...
            if (response.ok) {
                const data = await response.json();
                console.log('Saved profile:', data); // Debug log
                setUserProfile(data.profile);
                setEditForm(data.profile);
                setIsEditing(false);
    ...
    const activeCourses = userProfile.purchasedCourses ?
        userProfile.purchasedCourses.filter(c => c.status === 'in-progress').length : 0;
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="font-medium text-gray-700">{userProfile.email || 'Not provided'}</p>
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {isEditing ? (
                                                ...
                                                <p className="font-medium">{userProfile.school || 'Not provided'}</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                ...
                                {saveMessage && (
                                    <div className={`mt-4 p-3 rounded-lg text-center ${saveMessage.includes('successfully') ? 'bg-green-100 text-green-800' :
