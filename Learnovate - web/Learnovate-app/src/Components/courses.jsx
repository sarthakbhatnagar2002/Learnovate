        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mb-8 sm:mb-12">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full md:w-auto pl-10 p-4 rounded-xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 text-white appearance-none cursor-pointer"
            >
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold ${course.free ? 'bg-gradient-to-r from-green-500 to-emerald-500 text-white' : 'bg-purple-500 text-white'}`}>
